...
import { baseTemplates, heroRefName, heroRefsSorted, chatImages } from "@/lib/data";
...
const templateMeta: Record<string, { name: string; label: string }> = {
  ...
  "a-purple-template": { name: "A rank · purple base card", label: "A · purple" },
      ...
      <section className="atmosphere border-b border-line/60">
        <div className="mx-auto max-w-6xl px-4 pb-6 pt-7 sm:pb-8 sm:pt-10">
          ...
          <p className="mt-3 max-w-[640px] text-pretty text-[clamp(14px,2.5vw,17px)] leading-relaxed text-muted">
            ...
            You&rsquo;ll paste <strong className="text-cream">3 images + 1 prompt</strong>{" "}
            into ChatGPT — everything you need is on this page.
          </p>
          <div className="mt-4">
            <ProcessStrip
